...
public class ParNomeId implements InterfaceArvoreBMais<ParNomeId> {

  private String nome;
  private int id;
  private short TAMANHO = 100;
  ...
  public ParNomeId(String n, int i) throws Exception {
    int maxNomeBytes = this.TAMANHO - 4; // reservado 4 bytes para o int
    if(n.getBytes().length > maxNomeBytes)
      throw new Exception("Nome extenso demais. Diminua o número de caracteres (max " + maxNomeBytes + " bytes).");
  ...
  public byte[] toByteArray() throws IOException {
    ...
    byte[] vb = new byte[this.TAMANHO - 4];
